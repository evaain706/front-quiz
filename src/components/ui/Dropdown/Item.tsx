...
const DropdownItem = ({ children, onClick, className }: DropdownProps) => {
  ...
  return (
    <button
      className={cn(
        'md:text-md z-50 h-[3.6rem] w-[9.1rem] cursor-pointer rounded-[1.2rem] border-1 border-black bg-gray-100 text-[1.2rem] font-bold text-white md:h-[4.6rem] md:w-[10.8rem]',
        className,
      )}
      type='button'
